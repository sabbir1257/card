    ...
    <div className="template-container flex justify-center p-6 bg-gray-50">
      <div className="template-card business-card rounded-2xl">
        ...
        <div className="relative h-40">
          <img src="/bg-image.png" alt="" className="h-full w-full object-cover" />
        ...
        <div className="px-6 relative">
          {/* About Me */}
          <div className="mb-6 absolute top-20">
          ...
          {/* Contact Information */}
          <div className="space-y-3 absolute top-32">
            <ContactItem icon={<FaPhone />} text="012 5487 663" />
          ...
          {/* Social Media */}
          <div className="space-y-3 mt-6 absolute top-74">
          ...
          {/* Save Contact Button */}
          <div className="mt-6 mb-6 absolute top-[400px]">
            <button className="w-full max-w-48 bg-[#00aba1] text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center text-base hover:bg-[#009a91] transition">
